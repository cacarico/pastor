...
complete -c pastor -n "__fish_pastor_using_subcommand task; and __fish_seen_subcommand_from describe" -l json
...
complete -c pastor -n "__fish_pastor_using_subcommand machine; and not __fish_seen_subcommand_from add remove move list describe help" -f -a "remove"
complete -c pastor -n "__fish_pastor_using_subcommand machine; and not __fish_seen_subcommand_from add remove move list describe help" -f -a "move" -d 'Put a machine in another flock; tasks already on it stay there'
complete -c pastor -n "__fish_pastor_using_subcommand machine; and not __fish_seen_subcommand_from add remove move list describe help" -f -a "list" -d 'A line about the head, then each machine: host, flock, channel, herdr, agents'
complete -c pastor -n "__fish_pastor_using_subcommand machine; and not __fish_seen_subcommand_from add remove move list describe help" -f -a "describe" -d 'One machine in full: host, flock, channel, versions, agents, recent errors'
complete -c pastor -n "__fish_pastor_using_subcommand machine; and not __fish_seen_subcommand_from add remove move list describe help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c pastor -n "__fish_pastor_using_subcommand machine; and __fish_seen_subcommand_from describe" -l json
...
complete -c pastor -n "__fish_pastor_using_subcommand flock; and not __fish_seen_subcommand_from list add remove default edit describe help" -f -a "default" -d 'Make another flock the default; machines stay in their flocks'
...
complete -c pastor -n "__fish_pastor_using_subcommand flock; and __fish_seen_subcommand_from describe" -l json
...
complete -c pastor -n "__fish_pastor_using_subcommand job; and not __fish_seen_subcommand_from list enable disable run reload edit describe help" -f -a "reload" -d 'Re-read the job files now instead of at the next tick'
...
complete -c pastor -n "__fish_pastor_using_subcommand job; and __fish_seen_subcommand_from describe" -l json
...
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "serve" -d 'Run the daemon: scheduler, machine channels, dispatch'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "task" -d 'Manage tasks'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "machine" -d 'Manage the machines and which flock each is in'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "flock" -d 'Manage the flocks: named groups of machines that tasks and jobs target'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "open" -d 'Open the full herdr UI on a machine'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "tick" -d 'Run one scheduler pass now and report what it did'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "job" -d 'Manage jobs (files in ~/.config/pastor/jobs/)'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "config" -d 'pastor.toml: the head\'s settings and the task defaults'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "completions" -d 'Print a shell completion script (fish, bash, zsh, ...) to stdout'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "events" -d 'Show the events log (task, job and machine events)'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "setup" -d 'Install pastor or herdr as a user service (systemd, or launchd on macOS)'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "connector" -d 'Install, link, list and try out connectors'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "trust" -d 'The repos whose folder-trust prompt pastor answers on each machine'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job config completions events setup connector trust help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
