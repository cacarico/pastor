...
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and not __fish_seen_subcommand_from install link uninstall unlink list run help" -s h -l help -d 'Print help'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and not __fish_seen_subcommand_from install link uninstall unlink list run help" -f -a "install" -d 'Install a plugin from GitHub: owner/repo, or owner/repo/subdir'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and not __fish_seen_subcommand_from install link uninstall unlink list run help" -f -a "link" -d 'Use a plugin from a local directory, in place (for developing one)'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and not __fish_seen_subcommand_from install link uninstall unlink list run help" -f -a "uninstall" -d 'Remove an installed plugin (its .env and state are kept)'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and not __fish_seen_subcommand_from install link uninstall unlink list run help" -f -a "unlink" -d 'Remove a linked plugin; the directory itself is left alone'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and not __fish_seen_subcommand_from install link uninstall unlink list run help" -f -a "list" -d 'List plugins: version, connector, hooks, missing secrets'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and not __fish_seen_subcommand_from install link uninstall unlink list run help" -f -a "run" -d 'Run a plugin\'s connector once for a job and print its items; creates no tasks and saves no cursor'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and not __fish_seen_subcommand_from install link uninstall unlink list run help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from install" -l ref -d 'Branch, tag or commit to check out' -r
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from install" -l yes -d 'Do not ask for confirmation'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from install" -s h -l help -d 'Print help'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from link" -s h -l help -d 'Print help'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from uninstall" -s h -l help -d 'Print help'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from unlink" -s h -l help -d 'Print help'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from list" -l json
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from run" -l job -d 'The job whose [connector] config to use; need not exist yet' -r
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from run" -l since -d 'How far back `since` points (default: the job\'s backfill, or 0s)' -r
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from run" -s h -l help -d 'Print help'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "install" -d 'Install a plugin from GitHub: owner/repo, or owner/repo/subdir'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "link" -d 'Use a plugin from a local directory, in place (for developing one)'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "uninstall" -d 'Remove an installed plugin (its .env and state are kept)'
complete -c pastor -n "__fish_pastor_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "unlink" -d 'Remove a linked plugin; the directory itself is left alone'
...
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "serve" -d 'Run the daemon: scheduler, machine channels, dispatch'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "task" -d 'Manage tasks'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "machine" -d 'Manage the machines and which flock each is in'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "flock" -d 'Manage the flocks: named groups of machines that tasks and jobs target'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "open" -d 'Open the full herdr UI on a machine'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "tick" -d 'Run one scheduler pass now and report what it did'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "job" -d 'Manage jobs (files in ~/.config/pastor/jobs/)'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "completions" -d 'Print a shell completion script (fish, bash, zsh, ...) to stdout'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "events" -d 'Show the events log (task, job and machine events)'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "setup" -d 'Install pastor or herdr as a systemd user service'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "plugin" -d 'Install, link, list and try out plugins'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "trust" -d 'The repos whose folder-trust prompt pastor answers on each machine'
complete -c pastor -n "__fish_pastor_using_subcommand help; and not __fish_seen_subcommand_from serve task machine flock open tick job completions events setup plugin trust help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c pastor -n "__fish_pastor_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "install" -d 'Install a plugin from GitHub: owner/repo, or owner/repo/subdir'
complete -c pastor -n "__fish_pastor_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "link" -d 'Use a plugin from a local directory, in place (for developing one)'
complete -c pastor -n "__fish_pastor_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "uninstall" -d 'Remove an installed plugin (its .env and state are kept)'
complete -c pastor -n "__fish_pastor_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "unlink" -d 'Remove a linked plugin; the directory itself is left alone'
complete -c pastor -n "__fish_pastor_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "list" -d 'List plugins: version, connector, hooks, missing secrets'
complete -c pastor -n "__fish_pastor_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "run" -d 'Run a plugin\'s connector once for a job and print its items; creates no tasks and saves no cursor'
