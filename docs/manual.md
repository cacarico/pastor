...
A checkout removed since is created again. A stale task's agent is still
working in its checkout, so its retry gets a branch of its own. `pastor task close
