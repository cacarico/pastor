...
- Agents pastor starts may no longer change the fleet. Every agent's pane
  ...
  closes or prunes tasks, ticks (dry runs too), runs or reloads jobs, or
  edits machines, flocks or jobs fails with `agent_refused`; reads still work. The head refuses such a
